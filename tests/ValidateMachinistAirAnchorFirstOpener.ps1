...
Assert-Contains "docs/timeline_variables.md" "Air Anchor" "Timeline docs must explain the Air Anchor first opener variable"
...
Assert-NotContains "docs/timeline_variables.md" "尚未消费|not consumed|not yet consumed" "Timeline docs must not say the Air Anchor first variable is unused"
